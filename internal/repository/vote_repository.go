...
var (
	votes  = make(map[int]models.Vote)
	mu     sync.Mutex
	nextID = 1 // Начинаем с 1 и увеличиваем для каждого нового голосования
)
...
// GetVoteByID возвращает пользовательское голосование по его VoterID
...
// DeleteVote удаляет пользовательское голосование по его VoterID
